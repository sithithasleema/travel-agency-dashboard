...
export const user = { name: 'Sithi' };
export const dashboardStats = {
  totalUsers: 13543,
  usersJoined: { currentMonth: 213, lastMonth: 173 },
  totalTrips: 3210,
  tripsCreated: { currentMonth: 123, lastMonth: 153 },
  userRole: { total: 62, currentMonth: 23, lastMonth: 12 },
};
